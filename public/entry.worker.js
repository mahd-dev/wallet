...
const routes = {
  ...
  "routes/CategoryIconPicker": {
    id: "routes/CategoryIconPicker",
    parentId: "root",
    path: "CategoryIconPicker",
    index: void 0,
    caseSensitive: void 0,
    hasLoader: false,
    hasAction: false,
  ...
  "routes/api.resend-otp": {
    id: "routes/api.resend-otp",
    parentId: "root",
    path: "api/resend-otp",
    index: void 0,
    caseSensitive: void 0,
  ...
  "routes/api.verify-otp": {
    id: "routes/api.verify-otp",
    parentId: "root",
    path: "api/verify-otp",
    index: void 0,
    caseSensitive: void 0,
